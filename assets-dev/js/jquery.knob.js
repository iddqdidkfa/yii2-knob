...
(function (factory) {
    ...
    k.o = function () {
        ...
        this._draw = function () {
            ...
            (d !== false) && (this.o.dynamicDraw ? this.dynamicDraw(this.v) : s.draw());
    ...
    k.Dial = function () {
        ...
        this.animateDraw = function () {
            if (dynamicDrawIndex + dynamicDrawStep > this.v) {
                dynamicDrawStep = this.v - dynamicDrawIndex;
            }
            if(dynamicDrawIndex > this.v) {
                clearInterval(dynamicDrawInterval);
                this.v = dynamicDrawIndex;
            } else {
                this.draw(dynamicDrawIndex);
                this.change(dynamicDrawIndex);
                dynamicDrawIndex+= dynamicDrawStep;
            }
        };
